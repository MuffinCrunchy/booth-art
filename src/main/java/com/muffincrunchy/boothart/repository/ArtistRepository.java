...
public interface ArtistRepository extends JpaRepository<Artist, String> {
    ...
    @Modifying
    @Query(value = "INSERT INTO artists (id, name, birth_date, phone_no, email) VALUES (:id, :name, :birth_date, :phone_no, :email)", nativeQuery = true)
    int createArtist(@Param("id") String id, @Param("name") String name, @Param("birth_date") Date birthDate, @Param("phone_no") String phoneNo, @Param("email") String email);
